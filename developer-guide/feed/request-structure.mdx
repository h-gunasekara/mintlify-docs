...
description: 'How to structure your API requests and use filters/pagination with the Catalog Feed API'
---
This guide explains how to structure your requests to the Catalog Feed API, including how to use filters and pagination. All requests follow a consistent format to make integration straightforward.
...
### Different Vendor Example

<CodeGroup>
```json Different Vendor Request
{
  "vendor": "Jennikayne",
  "page": 1
}
