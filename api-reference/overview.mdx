...
The Catalog API provides endpoints for product search, discovery, and commerce intelligence.
...
<Card title="Search Products" icon="magnifying-glass" href="/api-reference/endpoints/search/agentic-search">
  **POST** `/api/search`
