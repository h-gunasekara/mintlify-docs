...
api: "GET https://catalogai.vercel.app/api/usage"
...
```bash cURL
curl -X GET "https://catalogai.vercel.app/api/usage?period=7d" \
  -H "x-api-key: YOUR_API_KEY"
```

```javascript JavaScript
const response = await fetch('https://catalogai.vercel.app/api/usage?period=7d', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://catalogai.vercel.app/api/usage?period=7d',
    headers={
        'x-api-key': 'YOUR_API_KEY'
    }
)
