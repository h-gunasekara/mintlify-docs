...
The Agentic Search Mini endpoint provides fast, intelligent product discovery enhanced with AI-powered attribute analysis. This lightweight endpoint is optimized for speed while still providing detailed product attributes through optional AI enrichment.
