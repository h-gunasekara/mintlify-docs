...
Discover products using intelligent search that combines Google Shopping results with AI-powered product analysis. This endpoint filters high-quality sources and provides enriched product data with detailed attributes.
...
<ParamField body="enable_enrichment" type="boolean" default="true">
  Enable AI-powered product attribute enrichment for enhanced product data analysis
</ParamField>

## Response

<ResponseField name="products" type="array">
  Array of discovered products with enriched data
