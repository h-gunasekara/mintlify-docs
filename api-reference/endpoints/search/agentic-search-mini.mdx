...
api: "POST https://catalogai.vercel.app/v1/agentic-search-mini"
...
```bash cURL
curl -X POST https://catalogai.vercel.app/v1/agentic-search-mini \
...
const response = await fetch('https://catalogai.vercel.app/v1/agentic-search-mini', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://catalogai.vercel.app/v1/agentic-search-mini',
    headers={
        'Content-Type': 'application/json',
        'x-api-key': 'YOUR_API_KEY'
    },
